...
ALLOWED_HOSTS = ['3e14-110-44-123-213.ngrok-free.app','localhost', '127.0.0.1']

CSRF_TRUSTED_ORIGINS = ['https://3e14-110-44-123-213.ngrok-free.app','https://*.127.0.0.1']
